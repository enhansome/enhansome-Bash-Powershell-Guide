...
1. [Bash/PowerShell Learning Resources](https://github.com/mikeroyal/Bash-PowerShell-Guide#bashpowershell-learning-resources) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

2. [Bash/PowerShell Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Bash-PowerShell-Guide#bashpowershell-tools-libraries-and-frameworks) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

3. [DevOps Tools Integration](https://github.com/mikeroyal/Bash-PowerShell-Guide#devops-tools-integration) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

4. [Kubernetes](https://github.com/mikeroyal/Bash-PowerShell-Guide#kubernetes) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

5. [Docker](https://github.com/mikeroyal/Bash-PowerShell-Guide#docker) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

6. [Azure Development](https://github.com/mikeroyal/Bash-PowerShell-Guide#azure-development) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

7. [AWS Development](https://github.com/mikeroyal/Bash-PowerShell-Guide#aws-development) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

8. [Google Cloud Platform Development](https://github.com/mikeroyal/Bash-PowerShell-Guide#google-cloud-platform-development) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

9. [VMware Development](https://github.com/mikeroyal/Bash-PowerShell-Guide#vmware-development) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

10. [Oracle Cloud Development](https://github.com/mikeroyal/Bash-PowerShell-Guide#oracle-cloud-development) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04

# Awesome Bash/PowerShell Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/Bash-PowerShell-Guide#table-of-contents) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,776 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-02, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,844 | 🐛 100 | 🌐 Rust | 📅 2026-09-03 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 329 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,873 | 🐛 80 | 🌐 Go | 📅 2026-09-03 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,718 | 🐛 221 | 🌐 Jinja | 📅 2026-09-03, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,718 | 🐛 221 | 🌐 Jinja | 📅 2026-09-03, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,718 | 🐛 221 | 🌐 Jinja | 📅 2026-09-03, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,718 | 🐛 221 | 🌐 Jinja | 📅 2026-09-03, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,718 | 🐛 221 | 🌐 Jinja | 📅 2026-09-03 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal
...
[Azure BatchExplorer](https://github.com/Azure/BatchExplorer#batchexplorer) ⭐ 205 | 🐛 141 | 🌐 TypeScript | 📅 2026-07-23 is a  client tool to help create, debug and monitor Azure Batch Applications.
...
[Azurite](https://github.com/Azure/Azurite/blob/master/README.md) ⭐ 2,253 | 🐛 370 | 🌐 TypeScript | 📅 2026-09-03 is an open source Azure Storage API compatible server (emulator). Based on Node.js, Azurite provides cross platform experiences for customers wanting to try Azure Storage easily in a local environment. Azurite simulates most of the commands supported by Azure Storage with minimal dependencies.
...
[AWS Serverless Application Model (SAM) CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,733 | 🐛 526 | 🌐 Python | 📅 2026-09-03 is a command line tool for an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. With just a few lines of configuration, you can define the application you want and model it.
...
[Oracle Domain Name System (DNS)](https://www.oracle.com/cloud/networking/dns/) is a distributed internet system that maps human-readable names (like [www.Oracle.com](http://www.Oracle.com)) to IP addresses and serves as the first link in the customers’ digital supply chain.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Bash-PowerShell-Guide/pulls) ⭐ 61 | 🐛 0 | 🌐 PowerShell | 📅 2024-01-04.
